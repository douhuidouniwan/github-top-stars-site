const repos = [
  ...
  },
  {
    ...
    description: "这个项目汇总亲手实现一个数据库、操作系统、编译器、Git、Docker 等教程。它抓住了工程学习里最有效的一点：通过复刻真实系统来理解设计取舍，而不是只读概念。",
    tags: ["底层原理", "动手项目", "系统学习"]
  },
  {
    rank: 6,
    ...
    description: "developer-roadmap 用可视化路线图解释前端、后端、DevOps、AI、数据等方向该学什么、先学什么。它的流行来自明确的路径感，尤其适合面对技术海量信息时做取舍。",
    tags: ["路线图", "职业成长", "技术栈"]
  },
  {
    rank: 7,
  ...
  },
  {
    ...
    category: "开发者劳动议题",
    language: "Rust / 文档",
    audience: "关注技术行业工作文化的人",
    url: "https://github.com/996icu/996.ICU",
    description: "996.ICU 是围绕互联网行业超长工作时间讨论形成的标志性仓库。它的 star 不只来自技术价值，也来自开发者群体对工作制度、职业健康和行业文化的表达。",
    tags: ["开发者文化", "劳动议题", "社区事件"]
  },
  {
    rank: 10,
    name: "awesome-python",
